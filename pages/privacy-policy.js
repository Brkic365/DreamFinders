      ...
      <main className={styles.main}>
        ...
        <section className={styles.policy}>
          ...
          <p>
            ...
            email address, phone number, and mailing address when you fill out a
            form on our website, sign up for our newsletter, or request
            information from us. We may also collect non-personal information
            such as your IP address, browser type, and operating system when you
            visit our website.
          </p>
          ...
          <p>
            ...
            implemented appropriate measures to safeguard it. Our website is
            encrypted using industry-standard SSL technology, and we use secure
            servers to store your information. We also limit access to your
            personal information to authorized personnel who need it to perform
            their duties.
          </p>
          <span>Your Rights</span>
          <p>
            You have the right to access and control your personal information.
            You can request that we update, correct, or delete your personal
